...
class HypoDialogViewSubviews3: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    */
    ...
    func load () {
        ...
        let path = NSBundle.mainBundle().pathForResource("symptomes2", ofType: "plist")
